...
class Clock(Scene):
	def setup(self):
		...
		circle.line_width = 6
		shadow = ('pink', 0, 0, 15)
		self.face = ShapeNode(circle, 'yellow', 'gold', shadow=shadow)
		...
		self.hands = []
		hand_attrs = [(r*0.55, 8, 'orange'), (r*0.75, 8, 'darkblue'), (r*0.75, 4, 'red')]
		...
		self.face.add_child(ShapeNode(ui.Path.oval(0, 0, 15, 15), 'cyan'))
